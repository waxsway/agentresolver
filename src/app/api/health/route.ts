  ...
  return NextResponse.json(
    {
      ...
      version: "0.1.4",
      purpose: "seller-side agent distribution for APIs/MCP with paid launch artifacts, live route verification, provider routing, and supporting buyer-side x402 checks",
      ...
      agentDistributionPack: "/api/agent-distribution-pack",
