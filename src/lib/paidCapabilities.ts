...
export const PAID_CAPABILITIES = {
  ...
  "x402-payment-preflight": {
    ...
    useWhen: "Before paying an unfamiliar x402 endpoint or when an agent needs API trust/security preflight, endpoint safety evidence, payment verification, payTo verification, or a USDC payment check: verify payTo, quote, network, asset, resource binding and live challenge evidence with bounded no-key behavior and deployment provenance.",
    costClass: "bounded-network",
