...
export const PAID_CAPABILITIES = {
  "abi-encode": {
    ...
    priceUsd: 0.02,
    atomicAmount: "20000",
    description: "ABI-encode typed Ethereum values into calldata-ready hex using human-readable Solidity parameter types.",
    ...
    quoteTool: { name: "abi_encode", title: "Ethereum ABI encode — $0.02", description: "Paid $0.02 USDC/Base exact Ethereum ABI encoding from typed JSON values to calldata-ready hex." }
  },
  "abi-decode": {
    id: "abi-decode",
    ...
    priceUsd: 0.02,
    atomicAmount: "20000",
    description: "ABI-decode Ethereum hex data against an ordered list of human-readable Solidity parameter types, returning JSON-safe values.",
    ...
    quoteTool: { name: "abi_decode", title: "Ethereum ABI decode — $0.02", description: "Paid $0.02 USDC/Base exact Ethereum ABI decoding into JSON-safe typed values." }
  },
  "eip712-hash": {
    id: "eip712-hash",
