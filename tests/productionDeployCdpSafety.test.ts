...
test("production deploy is one-shot re-armed specifically for the zero-account provider network release", () => {
  assert.match(workflow, /One-shot re-arm for the zero-account provider-network release/);
