...
test("focused public paid operations retain machine-invocable response schemas", () => {
  const x402 = readJson("public/.well-known/x402");
  const openapi = readJson("public/openapi.json");
  for (const id of ["agent-distribution-pack", "x402-ping", "x402-payment-preflight", "x402-settlement-verify", "verified-resolve", "batch-verified-resolve", "provider-launch-check"]) {
